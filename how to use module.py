'''HOW TO USE THE ARITHPROG MODULE'''

import ArithProg_noclass as AP
...
'''
        Errors, ang terms ay dapat Natural Numbers lang {1,2,3...}, bawal negative
                     1   2   3   4   5
        Number  :{   1   3   5   7   9  }
'''
